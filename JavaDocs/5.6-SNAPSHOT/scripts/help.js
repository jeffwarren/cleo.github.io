...
Demonstrates  help() built-in function. 
*/
// Print command info to debug file.
// VLTrader.dbg will show content similar to the following comments.
help();
	//    Command                Description 
	//    =======                =========== 
	//    help()                 Display usage and help messages. 
	//    arguments              Returns the arguments passed to the script
	//    environment            Returns the current environment object 
	//    load(["foo.js", ...])  Load JavaScript source files named by 
	//                           string arguments. 
	//    loadClass(className)   Load a class named by a string argument and execute. 
